    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5">
          <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-800 rounded-lg flex items-center justify-center shadow-lg shadow-blue-600/20">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a
            href="#contact"
            className="bg-blue-600 text-white px-5 py-2.5 rounded-lg font-semibold text-sm hover:bg-blue-700 transition shadow-lg shadow-blue-600/20"
          >
            Get Started
          </a>
        </nav>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 shadow-lg">
          <div className="px-6 py-4 space-y-3">
            ...
            <a
              href="#contact"
              className="block bg-blue-600 text-white px-5 py-3 rounded-lg font-semibold text-center hover:bg-blue-700 transition"
